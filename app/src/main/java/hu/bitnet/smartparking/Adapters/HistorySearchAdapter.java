...
public class HistorySearchAdapter extends RecyclerView.Adapter<HistorySearchAdapter.ViewHolder> {
    ...
    public HistorySearchAdapter(ArrayList<History> android) {
        this.android = android;
    }


    @Override
    public HistorySearchAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.card_history, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(HistorySearchAdapter.ViewHolder viewHolder, int i) {
